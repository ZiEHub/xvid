...
<?php wp_title( '|', true, 'right' );	bloginfo( 'name' );	$site_description = get_bloginfo( 'description', 'display' ); if ($site_description && (is_home() || is_front_page())) echo " | $site_description"; ?>
...
<script type='text/javascript' src='<?php echo get_template_directory_uri(); ?>/js/jquery.min.js?ver=v1.11.3'></script>
  ...
  <div class="row-fluid">
    ...
    <div class="span4">
      ...
      <h1>
        ...
        <?php _e('Search results for', 'ipin'); ?>
