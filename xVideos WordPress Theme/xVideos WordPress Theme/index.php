  ...
  <div id="masonry">
    ...
    <div id="post-<?php the_ID(); ?>" <?php post_class('thumb'); ?>>
      <div class="thumb-holder">
        <div class="masonry-actionbar"> <a class="btn btn-mini" href="<?php the_permalink(); ?>/#respond"><i class="icon-comment"></i>
          <?php _e('Comment', 'ipin'); ?>
          </a> <a class="btn btn-mini" href="<?php the_permalink(); ?>">
          <?php _e('View', 'ipin'); ?>
      ...
      <div class="masonry-meta<?php $show_avatars = get_option('show_avatars'); $comments_number = get_comments_number(); if ($comments_number == 0 && $show_avatars == '0') { echo ' text-align-center'; } ?>">
        ...
        <div class="masonry-meta-comment">
          <?php } ?>
          <span class="masonry-meta-author"><?php echo get_the_author_meta('display_name') ?></span>
          <?php _e('onto', 'ipin'); ?>
      ...
      <div class="masonry-meta">
        ...
        <div class="masonry-meta-comment">
          <?php } ?>
          <span class="masonry-meta-author"><?php echo $comment->comment_author; ?></span> <?php echo $comment->comment_content; ?>
          <?php if ($show_avatars == '1') { ?>
        </div>
        <?php } ?>
      </div>
      <?php 
				...
				?>
      <div class="masonry-meta text-align-center"> <span class="masonry-meta-author"> <a href="<?php the_permalink() ?>/#navigation" title="<?php _e('View all', 'ipin'); ?> <?php echo $comments_number; ?> <?php _e('comments', 'ipin') ?>">
        <?php _e('View all', 'ipin'); ?>
        <?php echo $comments_number; ?>
        <?php _e('comments', 'ipin') ?>
        </a> </span> </div>
      <?php } 
			}	?>
    </div>
      ...
      <div class="span6">
        <div class="post-wrapper">
          <div class="h1-wrapper">
            <h1>
              <?php _e( 'No Items Found', 'ipin' ); ?>
            </h1>
          </div>
          <div class="post-content text-align-center">
            <p>
              <?php _e('Perhaps searching will help.', 'ipin'); ?>
            </p>
            <?php get_search_form(); ?>
          </div>
        </div>
  ...
  <div id="navigation">
    <ul class="pager">
      <li id="navigation-next">
        <?php next_posts_link(__('&laquo; Previous', 'ipin')) ?>
      </li>
      <li id="navigation-previous">
        <?php previous_posts_link(__('Next &raquo;', 'ipin')) ?>
      </li>
    </ul>
  </div>
